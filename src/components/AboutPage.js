        ...
        <div className="AboutPage">
            ...
            <div className="AboutPagePicAndBlurb">
                ...
                <div className="AboutPageBlurb">
                    ...
                    <br />
                    I'd love to speak with you! Feel free to send me an email at <span className="GreenHighlight">karen.h1098@gmail.com</span> or connect with me on <span className="GreenHighlight"> <a href="https://www.linkedin.com/in/karenh1098/" target="_blank" rel="noreferrer">LinkedIn</a></span>.
                </div>
            </div>
        </div>
